export const meta = { slug: "/reference/changelog", title: "Changelog", documentationStatus: "under-review", appliesTo: "1.2.0", lastVerified: "2026-08-29" };

This page contains the complete version history recoverable from the repository's
own changelogs and version commits. Version 1.2.0 describes the prepared,
unreleased working tree. Versions 0.0.7 through 0.0.1 are visibly separated
...
to load on 29 August 2026. This entry describes the prepared source state;
it does not claim a release, tag, published package, visual qualification of every
look or successful download of every external LUT.

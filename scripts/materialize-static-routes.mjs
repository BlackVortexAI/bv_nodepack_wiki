...
const routes = [
  ...
  ["/node-guides/lut-library", "Use the LUT Library", "Choose built-ins, manage workflow LUTs, and test catalog channels."],
  ["/node-guides/lora-library", "Use the LoRA Library", "Collect local LoRAs and select workflow-scoped resources."],

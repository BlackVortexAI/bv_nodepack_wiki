...
if (contracts.targetVersion !== "1.0.0") errors.push(`Unexpected target version ${contracts.targetVersion}`);
if (contracts.nodes.length !== 51) errors.push(`Expected 51 public nodes, found ${contracts.nodes.length}`);
